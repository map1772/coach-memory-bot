...
async def demo(msg: Message):
    ...
    # рабочий вес у Игоря указан не для красоты: без него модель честно упирается в
    # нехватку данных и вместо плана задаёт уточняющий вопрос, а рядом с готовым
    # планом Ани сравнение двух ответов разваливается, ради которого демо и делалось
    b = {"name": "Игорь", "goal": "жим лёжа 120 кг, сейчас рабочий максимум 105 кг",
         "level": "опытный", "freq": "5", "equipment": "зал", "limits": "нет"}
